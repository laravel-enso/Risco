                ...
                appSubscriber: {
                    ...
                    methods: {
                        ...
                        subscribeToApp: function () {
                            ...
                            let self = this;
                            axios.post('/Risco', this.newApp).then(function(response) {
                ...
                applicationMetrics: {
                    ...
                    methods: {
                        deleteSubscribedApplication: function() {
                            ...
                            let self = this;
                            axios.delete('/Risco/' + this.applicationEntity.id)
                                .then(function(response) {
                        ...
                        updatePreferences: function () {
                            axios.post('/Risco/updatePreferences/' + this.applicationEntity.id, {preferences: this.preferences})
                                .then(function(response) {
                        ...
                        setMaintenanceMode: function () {
                            ...
                            axios.post('/Risco/setMaintenanceMode/' + this.applicationEntity.id)
                                .then(function(response) {
                        ...
                        clearLaravelLog: function () {
                            ...
                            axios.delete('/Risco/clearLaravelLog/' + this.applicationEntity.id, {params:payload})
                                .then(function(response) {
                        ...
                        getAllMetrics: function () {
                            ...
                            let self = this;
                            axios.get('/Risco/get/' + this.applicationEntity.id, {params:payload})
                                .then(function(response) {
